...
export async function auditNonText(page: Page, within = 'body *'): Promise<NonTextFailure[]> {
  return page.evaluate((rootSelector) => {
     ...
     *
     * A driven pass here walks the complete encrypted index, two square
     * heatmaps, a forty-row query ledger and a fourteen-node overlap graph —
     * thousands of sibling elements all re-walking the same ancestors up to
